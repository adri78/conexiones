                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6"><br>
                        <h4> <select name="INFOCMB" id="INFOCMB">
                                <option value="I1">Ventas Totales</option>
                                <option value="I2">Ventas Adrogue</option>
                                <option value="I3">Ventas Burzaco</option>
                                <option value="I4">Ventas Deposito</option>
                                <option value="I5">Compras Totales</option>
                                <option value="I6">Cambios Totales</option>
                                <option value="I7">Mov. Articulo</option>
                                <option value="I8">Mejores</option>
...
<script>
  ...
  */
   ...
   function PrintInfo2(){
       ...
       var url="Info.php?N=1"+x+"&desde="+Fec1+"&hasta="+ Fec2 ;//el uno ya esta
       window.open(url, '', 'width=830,height=652,scrollbars=NO,statusbar=NO,left=200,top=100');
   }
